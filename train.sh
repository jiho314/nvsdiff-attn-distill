...
CUDA_VISIBLE_DEVICES=6 accelerate launch --mixed_precision="bf16" \
                  --num_processes=1 --num_machines 1 --main_process_port 32122 \
                  --config_file configs/deepspeed/acc_zero2_bf16.yaml train.py \
                  --tracker_project_name "nvs-unet-feasibility" \
                  --output_dir="check_points/1101_distill_b10_crossperview_mlp1_L10_lw02_adatemp_co3d " \
                  ...
                  --log_every 4 \
                  --seed 0 \
                  --run_name 1101_distill_b10_crossperview_mlp1_L10_lw02_adatemp_co3d  \
                  --config_file="check_points/1101_distill_b10_crossperview_mlp1_L10_lw02_adatemp_co3d /config.yaml" \
